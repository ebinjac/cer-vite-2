...
import { 
  ...
  getServiceIdCustomStatus
} from '../utils/serviceid-utils'
import { customStatusColors, customStatusIcons } from '@/hooks/use-serviceids'
...
/**
 * Expiration status badge component with animation
 */
export function ExpirationStatusBadge({ expDate }: { expDate: string }) {
