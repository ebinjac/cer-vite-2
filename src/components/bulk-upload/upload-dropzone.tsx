import { UploadCloud, PaperclipIcon, XIcon, AlertCircleIcon } from 'lucide-react'
...
export function UploadDropzone({ maxSize, accept = '.csv', multiple = false, disabled, onFileReady, onClear }: Props) {
  const [
